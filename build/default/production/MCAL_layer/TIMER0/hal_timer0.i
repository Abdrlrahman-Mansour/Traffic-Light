...
# 12 "MCAL_layer/TIMER0/../Interrupt/mcal_interrupt_cfg.h"
# 1 "MCAL_layer/TIMER0/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MCAL_layer/TIMER0/../Interrupt/mcal_interrupt_cfg.h" 2
...
# 1 "MCAL_layer/TIMER0/../Interrupt/../mcal_std_lib.h" 1
# 12 "MCAL_layer/TIMER0/../Interrupt/../mcal_std_lib.h"
# 1 "MCAL_layer/TIMER0/../Interrupt/../std_libararies.h" 1
# 12 "MCAL_layer/TIMER0/../Interrupt/../std_libararies.h"
...
# 12 "MCAL_layer/TIMER0/../Interrupt/../std_libararies.h" 2
...
# 13 "MCAL_layer/TIMER0/../Interrupt/../std_libararies.h" 2
...
# 14 "MCAL_layer/TIMER0/../Interrupt/../std_libararies.h" 2
# 12 "MCAL_layer/TIMER0/../Interrupt/../mcal_std_lib.h" 2

# 1 "MCAL_layer/TIMER0/../Interrupt/../Compiler.h" 1
# 12 "MCAL_layer/TIMER0/../Interrupt/../Compiler.h"
...
# 12 "MCAL_layer/TIMER0/../Interrupt/../Compiler.h" 2
# 13 "MCAL_layer/TIMER0/../Interrupt/../mcal_std_lib.h" 2
# 23 "MCAL_layer/TIMER0/../Interrupt/../mcal_std_lib.h"
...
# 14 "MCAL_layer/TIMER0/../Interrupt/../GPIO/hal_gpio.h" 2
# 31 "MCAL_layer/TIMER0/../Interrupt/../GPIO/hal_gpio.h"
typedef enum {
    LOW,
    HIGH
}logic_t;
...
# 47 "MCAL_layer/TIMER0/hal_timer0.h"
typedef enum {
...
static __attribute__((inline)) void Timer0_Reg_Size(const timer0_t *timer);
...
static __attribute__((inline)) void Timer0_Mode_Select(const timer0_t *timer){
    if(1 == timer->timer0_mode){
        ...
        (T0CONbits.T0CS = 1);
        if(1 == timer->timer0_edge){
            (T0CONbits.T0SE = 0);
        }
        else if (0 == timer->timer0_edge){
            (T0CONbits.T0SE = 1);
        }
        else{ }
    }
...
static __attribute__((inline)) void Timer0_Reg_Size(const timer0_t *timer){
    if(1 == timer->timer0_reg_size){
        (T0CONbits.T08BIT = 1);
    }
    else if (0 == timer->timer0_reg_size){
        (T0CONbits.T08BIT = 0);
    }
    else{ }
}
