...
unsigned char DIO_u8read(unsigned char portname,unsigned char pinnumber)
{
	...
	{
		case 'A' :
		return_value=READ_BIT(PORTA,pinnumber);//Read the value from the given pin in port A
		break;
		
		case 'B' :
		return_value=READ_BIT(PORTB,pinnumber);//Read the value from the given pin in port B
		break;
		
		case 'C' :
		return_value=READ_BIT(PORTC,pinnumber);//Read the value from the given pin in port C
		break;
		
		case 'D' :
		return_value=READ_BIT(PORTD,pinnumber);//Read the value from the given pin in port D
		break;
		default: 
		break;
	}
